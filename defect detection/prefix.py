...
from OpenDelta.opendelta import  PrefixModel
import argparse
import logging
import os
import torch
...
from adapter import train , evaluate , test
...
def main():
    ...
    delta_model = PrefixModel(backbone_model=model, prefix_token_num=16 ,  mid_dim=400)
